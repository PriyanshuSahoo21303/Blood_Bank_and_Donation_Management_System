    ...
    <div class="row">
      <div class="col-md-12">
        <div class="row">
          ...
          <!-- Available Blood Banks Section -->
          <div class="col-md-3">
            <div class="panel panel-default panel-info" style="border-radius:50px;">
              <div class="panel-body panel-info bk-primary text-light" style="background-color:#F9E79F; border-radius:50px;">
                <div class="stat-panel text-center">
                  <?php
                  $sql2 = "SELECT * FROM blood_banks";
                  $result2 = mysqli_query($conn, $sql2) or die("Query failed.");
                  $row2 = mysqli_num_rows($result2);
                  ?>
                  <div class="stat-panel-number h1"><?php echo $row2; ?></div>
                  <div class="stat-panel-title text-uppercase">Available Blood Banks</div>
                  <br>
                  <button class="btn btn-success" onclick="window.location.href = 'bloodbank_list.php';">
                    View Blood Banks <i class="fa fa-arrow-right"></i>
                  </button>
                </div>
              </div>
            </div>
