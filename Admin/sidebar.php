...
<div class="sidebar"><b>
  ...
  <a href="donor_list.php"   <?php if($active == 'list') echo "class='act'"; ?>><span class="glyphicon glyphicon-list-alt"></span>&nbsp&nbspDonor List</a>
  ...
  <!-- Added Update Blood Banks Option -->
  <!-- <a href="update_bloodbanks.php"   <?php if($active == 'update_blood_banks') echo "class='act'"; ?>><span class="glyphicon glyphicon-edit"></span>&nbsp&nbspUpdate Blood Banks</a> -->
  <a href="update_bloodbanks.php"   <?php if($active == 'update_bloodbanks') echo "class='act'"; ?>><span class="glyphicon glyphicon-pencil"></span>&nbsp&nbspUpdate Bloodbanks</a>
  <a href="bloodbank_list.php"   <?php if($active == 'list_blood_banks') echo "class='act'"; ?>><span class="glyphicon glyphicon-list-alt"></span>&nbsp&nbspBlood Bank List</a>
