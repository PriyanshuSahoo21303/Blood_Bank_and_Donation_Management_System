...
<div id="sidebar">
<?php $active = "list_blood_banks"; include 'sidebar.php'; ?>
</div>
<div id="content">
    ...
    <div class="container-fluid">
      <div class="row">
        <div class="col-md-12 lg-12 sm-12">
          ...
          <h1 class="page-title" style="color: white;">Blood Bank List</h1>
      ...
      <?php
        ...
        $offset = ($page - 1) * $limit;
        $count = $offset + 1;
        $sql = "SELECT * FROM blood_banks LIMIT {$offset}, {$limit}";
      ...
      <div class="table-responsive">
        <table class="table table-bordered" style="text-align: center; 
          ...
          <thead style="text-align:center">
            ...
            <th style="text-align:center">Available Blood Groups</th>
            ...
            while ($row = mysqli_fetch_assoc($result)) { ?>
              <tr>
                ...
                <td id="he" style="width:100px">
                  <a style="background-color:aqua" href='delete_bloodbank.php?id=<?php echo $row['id']; ?>'>Delete</a>
                </td>
              </tr>
            <?php } ?>
          </tbody>
